(function(window, createjs, opspark, _) {
  ...
  function update(event) {
    ...
    // TODO 1: bounce the ball off the to
    ...
    if (ball.x + ball.radius >= paddleCPU.x && ball.x + ball.radius >= widthCPU + paddleCPU.x  && ball.y - ball.radius >= paddleCPU.y && ball.y + ball.radius <= heightCPU + paddleCPU.y){
        ball.yVelocity *= -1
